...
function Registrar_Docente($id_docente,$nombre,$apellido,$usuario, $contra, $cbm_rol,$NameImg){
  $id_docente = $id_docente? $id_docente:'0';
    $sql = "INSERT INTO usuarios(identidad,usu_usuario,usu_nombre,usu_apellidos,usu_contrasena,rol_id,imagen)
     VALUES ('$id_docente','$usuario','$nombre','$apellido','$contra','$cbm_rol','$NameImg')";
        if ($consulta = $this->conexion->conexion->query($sql)) {
       return 1;
        }else{
            return 0;
...
function Registrar_Alumno($id_alumno,$nombre,$apellido,$usuario, $contra, $cbm_rol,$NameImg){
  $id_alumno = $id_alumno? $id_alumno:'0';
  $sql = "INSERT INTO usuarios(identidad,usu_usuario,usu_nombre,usu_apellidos,usu_contrasena,rol_id,imagen)
   VALUES ('$id_alumno','$usuario','$nombre','$apellido','$contra',' $cbm_rol','$NameImg')";
        if ($consulta = $this->conexion->conexion->query($sql)) {
       return 1;
        }else{
            return 0;
...
function Registrar_Usuario($id_otro,$nombre,$apellido,$usuario,$contra, $cbm_rol,$NameImg){
  $id_otro=$id_otro? $id_otro:'0';
  $sql = "INSERT INTO usuarios(identidad,usu_usuario,usu_nombre,usu_apellidos,usu_contrasena,rol_id,imagen)
   VALUES ('$id_otro','$usuario','$nombre','$apellido','$contra',' $cbm_rol','$NameImg')";
        if ($consulta = $this->conexion->conexion->query($sql)) {
       return 1;
        }else{
            return 0;
