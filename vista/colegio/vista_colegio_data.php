...
<div class="row">
         <div class="col-xs-12">
        <div class="col-md-4">
          <label >UGEL(Unidad de Gestión Educativa Local)</label>

           <input type="text" name="" class="form-control" id="txt_ugel" onkeypress = "return (event.charCode > 64 &&   event.charCode < 91) ||
             (event. charCode > 96 && event.charCode < 123)||
             (event. charCode > 31 && event.charCode < 33)" ><br>
        </div>
        <div class="col-md-4" >
