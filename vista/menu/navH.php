          ...
          <a>
            ...
            <ul class="treeview-menu">
                  ...
                  <!--<li><a onclick="cargar_contenido('contenido_principal','configuracion/vista_fase_periodo.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Fase & periodo</a></li>-->
                   ...
                   <li><a onclick="cargar_contenido('contenido_principal','configuracion/vista_fase_escolar.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Fase Escolar</a></li>
         ...
         <li class="treeview">
          <a>
            ...
            <ul class="treeview-menu">
                  ...
                  <li><a onclick="cargar_contenido('contenido_principal','curso/vista_cargaActividad_curso.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Carga Acad&eacute;mico</a></li>
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          <a>
           ...
           <li class="treeview">
          <a>
            <i class="fa fa-calendar-minus-o"></i> <span style="cursor: pointer;">Penciones</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
         ...
         <li class="treeview">
          <a>
            ...
            <ul class="treeview-menu">
                   <li><a onclick="cargar_contenido('contenido_principal','notas/vista_registro_notas.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Registro</a></li>
                  <li><a onclick="cargar_contenido('contenido_principal','notas/vista_reporte_notas.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Reporte</a></li>
                  <li><a onclick="cargar_contenido('contenido_principal','notas/vista_notas_periodos.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Bimestrales</a></li>
                  <li><a onclick="cargar_contenido('contenido_principal','notas/vista_notas_tripleT.php')" style="cursor: pointer;"><i class="fa fa-circle-o"></i>Acumulados</a></li>
     ...
     <li class="treeview">
       ...
       <li class="treeview">
         ...
         <li class=" treeview">
          ...
          <li class="treeview">
          <a>
           <i class="fa  fa-cog"></i> <span style="cursor: pointer;">Configuracion</span>
            <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
            </span>
            <ul class="treeview-menu" style="background: #020d12">
                   ...
                   <li>
                    ...
                    <i class=" fa  fa-pencil-square-o"></i> <span style="cursor: pointer;">Tipos evaluaciíon</span>
                    <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
          ...
          <a>
           <i class="fa fa-fw fa-dollar"></i> <span style="cursor: pointer;">Contabilidad</span>
            ...
            <ul class="treeview-menu" style="background: #020d12">
                  ...
                  <li><a onclick="cargar_contenido('contenido_principal','exit/view_list_exit.php')" style="cursor: pointer;"><i class="fa fa-arrow-circle-o-up"></i>categorías engreso</a></li>
