        ...
        <div class="box-header titulosclass" id="Titulo_Center">
            ...
            <div class="box-body">
                 ...
                 <div class="col-lg-12">
                    ...
                    <input type="text " class="form-control" id="txt_nom" placeholder="ejemplo:PRIMER GRADO" onkeypress = "return (event.charCode > 64 &&   event.charCode < 91) ||
                ...
                <div class="col-lg-12">
                    ...
                    <select class="js-example-basic-single" name="state" id="cbm_turnos" style="width:100%;">
                      <option value="">--Seleccione--</option>
                        ...
                        <option value="5">MATURDINO</option>
                    </select><br><br>
                </div>
