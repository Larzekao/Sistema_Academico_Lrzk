...
<div class="col-md-4">
  <div class="box box-warning">
    <div class="box-body box-profile" style="border:none;">
      <img class="profile-user-img img-responsive img-circle" src="../../imagenes/images.png" alt="User profile picture">
  ...
  <div class="box-body">
   ...
   <div class="row">
    <div class="col-xs-12">
      ...
      <div class="alin_global">
        <input type="number" class="form-control" id="txt_pago" placeholder="S/. 0" >
