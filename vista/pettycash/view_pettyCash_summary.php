          ...
          <div class="info-box-content">
            <div class="" style="margin-top: 10px"><h5 class="">
              ...
              <div> <a  class="small-box-footer" style="color: #f7f5f3;cursor: pointer;font-size: 25px">
                <strong id="total_entry">S/. 0.00</strong> </a>
              </div> 
            </div> 
          </div> 
        </div>
        ...
        <div class="info-box bg-purple" style="border-radius: 6px"><span class="info-box-icon" style="width: 70px;border-radius: 6px">
          ...
          <div class="info-box-content">
            <div class="" style="margin-top: 10px"><h5 class="">
              ...
              <div> <a  class="small-box-footer" style="color: #f7f5f3;cursor: pointer;font-size: 25px"><strong id="total_exit">S/. 0.00</strong> </a>
              </div> 
            </div> 
          </div> 
        </div>
        ...
        <div class="info-box bg-orange" style="border-radius: 6px"><span class="info-box-icon" style="width: 70px;border-radius: 6px">
          ...
          <div class="info-box-content">
            <div class="" style="margin-top: 10px"><h5 class="">
              ...
              <div> <a  class="small-box-footer" onclick="Summary_exit_entry()" style="color: #f7f5f3;cursor: pointer;font-size: 25px"><strong id="total_summary">S/. 0.00</strong> </a>
              </div> 
            </div> 
          </div> 
        </div>
        ...
        <div class="info-box bg-navy" style="border-radius: 6px"><span class="info-box-icon" style="width: 70px;border-radius: 6px">
          ...
          <div class="info-box-content">
            <div class="" style="margin-top: 10px"><h5 class="">
              ...
              <div> <a  class="small-box-footer" style="color: #f39c12;cursor: pointer;font-size: 25px"><strong id="pettycash_summary">S/. 0.00</strong> </a>
              </div> 
            </div> 
          </div> 
        </div>
